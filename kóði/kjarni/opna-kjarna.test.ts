...
describe("kjarna-viðmót", () => {
  test("opnaKjarna skilar hráu native viðmóti með handvirkri lokun", async () => {
  ...
  test("opnaKjarna styður Symbol.dispose sem alias á loka", async () => {
  ...
  test("opnaKjarnaÓsamstillt skilar sama native viðmóti", async () => {
    const slóð = await smíðaPrófkjarna(
