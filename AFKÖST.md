...
| :----------------------------------------------------- | :---------------------------- | :--------------------------- | ----: | -----: |
| `hefurAuðkenni(þekkt auðkenni)`                        | auðkenni eru til              | 5 auðkenni, 128 uppslög/ít.  |  4 ns |   7 ns |
| `hefurAuðkenni(tóm auðkenni)`                          | innan leyfilegs sviðs         | 32 auðkenni, 128 uppslög/ít. |  4 ns |   5 ns |
| `hefurAuðkenni(utan sviðs)`                            | utan leyfilegs sviðs          | 32 auðkenni, 128 uppslög/ít. |  5 ns |   5 ns |
