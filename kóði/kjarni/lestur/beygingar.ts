...
export function sækjaSíaðarFærslurÚrStofni(
  ...
  // Þessar maskaslóðir eru viljandi sérhæfðar hér í stað almennrar yfirferðar
  // sem kallar í `passar(...)`. `viðmið/innra/beygingarsnið.ts` sýndi að óbein
  // köllun í hverri röð bætti við um ~6-9 ns á röð miðað við beinan lykkjukjarna.
