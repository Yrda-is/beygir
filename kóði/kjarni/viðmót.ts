...
/**
 * Stefja fyrir {@link lesaUppflettiorð}; skilaðu `false` til að stöðva lestur.
 */
export type VinnaUppflettiorð = (uppflettiorð: Uppflettiorð) => false | undefined;

/**
 * Stefja fyrir {@link lesaBeygingarmyndir}; skilaðu `false` til að stöðva lestur.
 */
export type VinnaBeygingarmynd = (auðkenni: Auðkenni, beygingarmynd: string) => false | undefined;

/**
 * Stefja fyrir {@link lesaBeygingarfærslur}; skilaðu `false` til að stöðva lestur.
 */
...
export interface Beygir {
   ...
   * við skal nota {@link hefurUppflettiorð} eða {@link hefurBeygingarfærslu}.
   * Ath. einnig {@link hefurAuðkenni} ef BÍN-auðkennið er til staðar.
   *
   ...
   * ```
   * @see {@link hefurAuðkenni} ef BÍN-auðkennið er til staðar.
   */
   ...
   * ```
   *
   * @see {@link sækja} til að skila gögnunum.
   */
   ...
   * sem viðfang í aðgerðir eins og {@link beygingar} og {@link beygingarmyndir}.
   *
   * Flækjustig: `O(1)`. Notar `AUDK` uppflettitöfluna beint.
   *
   * @param auðkenni BÍN-auðkennið sem á að athuga.
   ...
   * ```
   *
   * @see {@link finnaUppflettiorð} til að finna eftir uppflettiorði.
   * @see {@link finnaUppflettiorðAfBeygingarmynd} til að finna uppflettiorð út frá beygingarmynd.
   */
   ...
   * aðeins uppflettiorðum; notaðu {@link finnaBeygingarfærslur} eða
   * {@link finnaUppflettiorðAfBeygingarmynd} þegar inntakið er beygingarmynd.
   *
   * Flækjustig: `O(t + u)`, þar sem `t` er fjöldi tætifallsprófana í
   ...
   * @param sía Valfrjáls sía á uppflettiorð.
   * @param velja Vörpun yfir uppflettiorð.
   ...
   * ```
   *
   * @see {@link finnaUppflettiorðAfBeygingarmynd} þegar inntakið er beygingarmynd.
   */
   ...
   * ```
   *
   * @see {@link hefur} þegar aðeins þarf tilvist.
   * @see {@link finnaUppflettiorð} þegar inntakið á að vera nákvæmt uppflettiorð.
   * @see {@link finnaUppflettiorðAfBeygingarmynd} þegar inntakið á að vera beygingarmynd.
   */
   ...
   * ```
   *
   * @see {@link finnaBeygingarfærslur} ef þú þarft mörk eða nákvæma formfærslu.
   */
   ...
   * nota skal {@link finnaUppflettiorðAfBeygingarmynd} þegar þú þarft einstök
   ...
   * @param velja Vörpun yfir ítarlega færslu.
   ...
   * `[]`. Færslan verður að vera gild fyrir þennan kjarna.
   * Þegar inntakið er strengur þarf fyrst að finna formfærslu með
   * {@link finnaBeygingarfærslur} og færa síðan einstaka niðurstöðu í nýtt fall.
   *
   ...
   * ```
   *
   * @see {@link finnaBeygingarfærslur} til að fá `Færsla` úr texta.
   */
